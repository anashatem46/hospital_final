...
public class modify extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            String sql = "Update patint set Name='" + jTextField3.getText()+"',Blood='"+jTextField6.getText()+"',Phone='"+jTextField5.getText()+"',Gender='"+jTextField4.getText()+"'"+ " WHERE id="+jTextField2.getText();
